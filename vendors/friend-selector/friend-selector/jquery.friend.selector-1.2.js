...
;(function(window, document, $, undefined) {
  ...
  _setFacebookFriends = function (k, v, predefined) {
    ...
    var link =  '<a class="fs-anchor" href="javascript://">' +
                  ...
                  //added by shahid on 11 sept 2012
                  '<input type="hidden" value="' + v[k].name + '" id="fbUser'+v[k].id+'"  />' +
  ...
  _resize = function( is_started ) {
    ...
    var docHeight = $(document).height(),
        ...
        //added by shahid because .. box was showing at the bottom of the page instead of middle.
        wrapTop = 50;
