      ...
      if ($this->useElFinder) {
          $options['file_browser_callback'] = 'js:function(field_name, url, type, win) {
            ...
            if($("#finder").length == 0) {
                ...
                //$("#finder").elfinder({ zIndex: 9999999, places: "Favorites", url : "'.Yii::app()->urlManager->createUrl('backend/elfinder/default/connector').'",
                ...
                $("#finder").elfinder({ zIndex: 9999999, places: "Favorites", url : "'.Yii::app()->getAssetManager()->publish(dirname(__FILE__).DIRECTORY_SEPARATOR.'assets').'/elfinder/connectors/connector.php?url='.Yii::app()->baseUrl.'/uploads'.'/", 
                    lang : "en",
                    dialog : { width : 900, modal : true, title : "The File Manager", zIndex: 7777777 },
