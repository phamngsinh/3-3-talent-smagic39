...
class JobTestimonialsController extends Controller {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('JobTestimonials');
    ...
    public function actionAdmin() {
        $model = new JobTestimonials('search');
     ...
     * @return JobTestimonials the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = JobTestimonials::model()->findByPk($id);
        if ($model === null)
     ...
     * @param JobTestimonials $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'job-testimonials-form') {
