...
class JobLocationController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['JobLocation'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->job_location_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('JobLocation');
	...
	{
		$model=new JobLocation('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['JobLocation']))
			$model->attributes=$_GET['JobLocation'];
	...
	{
		$model=JobLocation::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param JobLocation $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='job-location-form')
		{
