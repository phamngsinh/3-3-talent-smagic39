...
<div class="form">
    ...
    <div class="row">
      ...
      <div class="row">
        <?php echo $form->labelEx($model, 'recruiter_email'); ?>
        <?php echo $form->textField($model, 'recruiter_email', array('size' => 60, 'maxlength' => 255)); ?>
        <?php echo $form->error($model, 'recruiter_email'); ?>
    </div>
      <div class="row">
        <?php echo $form->labelEx($model, 'recruiter_name'); ?>
        <?php echo $form->textField($model, 'recruiter_name', array('size' => 60, 'maxlength' => 255)); ?>
        <?php echo $form->error($model, 'recruiter_name'); ?>
    </div>
    <div class="row">
