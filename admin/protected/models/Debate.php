...
class Debate extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('debate_title, image, favour_title, favour_video, favour_description, against_title, against_description, against_video,start_date,  expire_date, is_featured', 'required'),
			//array('is_featured', 'numerical', 'integerOnly'=>true),
			array('debate_title, image, favour_title, favour_video, against_title, against_video, expire_date', 'length', 'max'=>255),
