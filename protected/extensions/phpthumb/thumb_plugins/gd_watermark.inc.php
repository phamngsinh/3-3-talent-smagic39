...
public function createWatermark ($watermark, $pad_x, $pad_y, $that)
{
...
imagecopy($this->parentInstance->getOldImage(), $watermark, $pad_x, $pad_y, 0, 0, $watermarksize[0], $watermarksize[1]);
