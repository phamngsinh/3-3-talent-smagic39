...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'selected_friends'); ?>
		<?php echo $form->textField($model,'selected_friends',array('size'=>60,'maxlength'=>250)); ?>
		<?php echo $form->error($model,'selected_friends'); ?>
	</div>
