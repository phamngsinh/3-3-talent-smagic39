<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('total_votes')); ?>:</b>
	<?php echo CHtml::encode($data->total_votes); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('total_downloads')); ?>:</b>
	<?php echo CHtml::encode($data->total_downloads); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('selected_friends')); ?>:</b>
	<?php echo CHtml::encode($data->selected_friends); ?>
	<br />
