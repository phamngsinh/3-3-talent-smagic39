...
class CustomPager extends CLinkPager
{
	...
	protected function createPageButton($label,$page,$class,$hidden,$selected)
	{
		...
		if(is_int($label))
		{
		    ...
		    if($class == "page")
		    {
			//$label = "<img src='images/unselect_page.png' />";
		    }
		    else
		    {
			//$label = "<img src='images/select_page.png' />";
		    }
		    
		}
		
		return '<li class="'.$class.'" onclick="customPagerLinkClicked(\''.(int)($page+1).'\')">'.CHtml::link($label,$this->createPageUrl($page)).'</li>';
	}
