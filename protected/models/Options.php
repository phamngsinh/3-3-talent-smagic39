...
class Options extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('question_id, option, is_correct', 'required'),
			array('question_id, is_correct', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('score, id, question_id, option, is_correct', 'safe', 'on'=>'search'),
		);
	}
